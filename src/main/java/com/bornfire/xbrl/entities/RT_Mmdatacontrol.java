...
public class RT_Mmdatacontrol {
	 @Id
		...
		public RT_Mmdatacontrol(Date portfolioDate, String submittingInstitution, String contactEmployee1Name1,
				String contactEmployee1Title1, String contactEmployee1Email1, String contactEmployee2Name2,
				String contactEmployee2Title2, String contactEmployee2Email2, String signOffCroName,
				String signOffCroEmail, String signOffCfoName, String signOffCfoEmail, String signOffHeadOfTreasuryName,
				String signOffHeadOfTreasuryEmail, String auditedData, Date reportSubmitDate, Date reportFromDate,
