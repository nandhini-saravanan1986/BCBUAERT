...
public class Stableresourcesratio_entity {
	...
	public String toString() {
		return "Stableresourcesratio [r1_product=" + r1_product + ", r1_amount=" + r1_amount + ", r2_product="
				+ r2_product + ", r2_amount=" + r2_amount + ", r3_product=" + r3_product + ", r3_amount=" + r3_amount
				+ ", r4_product=" + r4_product + ", r4_amount=" + r4_amount + ", r5_product=" + r5_product
				+ ", r5_amount=" + r5_amount + ", r6_product=" + r6_product + ", r6_amount=" + r6_amount
				+ ", r7_product=" + r7_product + ", r7_amount=" + r7_amount + ", r8_product=" + r8_product
				+ ", r8_amount=" + r8_amount + ", r9_product=" + r9_product + ", r9_amount=" + r9_amount
				+ ", r10_product=" + r10_product + ", r10_amount=" + r10_amount + ", r11_product=" + r11_product
				+ ", r11_amount=" + r11_amount + ", r12_product=" + r12_product + ", r12_amount=" + r12_amount
				+ ", r13_product=" + r13_product + ", r13_amount=" + r13_amount + ", r14_product=" + r14_product
				+ ", r14_amount=" + r14_amount + ", r15_product=" + r15_product + ", r15_amount=" + r15_amount
				+ ", r16_product=" + r16_product + ", r16_amount=" + r16_amount + ", r17_product=" + r17_product
				+ ", r17_amount=" + r17_amount + ", r18_product=" + r18_product + ", r18_amount=" + r18_amount
				+ ", r19_product=" + r19_product + ", r19_amount=" + r19_amount + ", r20_product=" + r20_product
				+ ", r20_amount=" + r20_amount + ", r21_product=" + r21_product + ", r21_amount=" + r21_amount
				+ ", r22_product=" + r22_product + ", r22_amount=" + r22_amount + ", r23_product=" + r23_product
				+ ", r23_amount=" + r23_amount + ", r24_product=" + r24_product + ", r24_amount=" + r24_amount
				+ ", r25_product=" + r25_product + ", r25_amount=" + r25_amount + ", r26_product=" + r26_product
				+ ", r26_amount=" + r26_amount + ", r27_product=" + r27_product + ", r27_amount=" + r27_amount
	...
	public Stableresourcesratio_entity(String r1_product, BigDecimal r1_amount, String r2_product, BigDecimal r2_amount,
			String r3_product, BigDecimal r3_amount, String r4_product, BigDecimal r4_amount, String r5_product,
			BigDecimal r5_amount, String r6_product, BigDecimal r6_amount, String r7_product, BigDecimal r7_amount,
			String r8_product, BigDecimal r8_amount, String r9_product, BigDecimal r9_amount, String r10_product,
			BigDecimal r10_amount, String r11_product, BigDecimal r11_amount, String r12_product, BigDecimal r12_amount,
			String r13_product, BigDecimal r13_amount, String r14_product, BigDecimal r14_amount, String r15_product,
			BigDecimal r15_amount, String r16_product, BigDecimal r16_amount, String r17_product, BigDecimal r17_amount,
			String r18_product, BigDecimal r18_amount, String r19_product, BigDecimal r19_amount, String r20_product,
			BigDecimal r20_amount, String r21_product, BigDecimal r21_amount, String r22_product, BigDecimal r22_amount,
			String r23_product, BigDecimal r23_amount, String r24_product, BigDecimal r24_amount, String r25_product,
			BigDecimal r25_amount, String r26_product, BigDecimal r26_amount, String r27_product, BigDecimal r27_amount,
	...
	public Stableresourcesratio_entity() {
		super();
